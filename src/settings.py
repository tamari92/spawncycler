...
class SettingsDialog(object):
    ...
    def setup_fields(self):
        ...
        autosave_interval_children['Textfield'].editingFinished.connect(partial(self.commit_textbox, autosave_interval_children['Textfield'], 'autosave_interval', 0, None))
